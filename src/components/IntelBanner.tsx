          ...
          {showSettings ? (
            ...
            <div className="flex flex-col flex-1">
              ...
              <div className="flex flex-col gap-3 border-t border-white/10 pt-4 flex-shrink-0">
                ...
                {!isStandalonePwa && (
                  <button
                    onClick={() => { setShowInstallTutorial(true); setShowAbout(false); }}
                    className="flex items-center justify-between w-full px-4 py-2.5 rounded-xl bg-blue-500/10 hover:bg-blue-500/20 text-blue-300 transition-all border border-blue-500/20 shadow-lg active:scale-[0.98]"
                  >
                    <div className="flex items-center gap-3">
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                        <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" /><polyline points="7 10 12 15 17 10" /><line x1="12" y1="15" x2="12" y2="3" />
                      </svg>
                      <span className="text-[13px] font-bold">הוסף למסך הבית</span>
                    </div>
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" className="opacity-30">
                      <path d="M9 18l6-6-6-6" />
                    </svg>
        ...
        <div className="absolute top-16 left-3 right-3 sm:left-1/2 sm:right-auto sm:-translate-x-1/2 sm:w-[480px] z-[2000] pointer-events-none" dir="rtl">
          <div className="liquid-glass border border-red-500/25 rounded-xl px-3 py-2 shadow-lg shadow-red-500/10 pointer-events-auto flex items-center gap-2">
            ...
            <button
              ...
              className="flex-shrink-0 text-white/30 hover:text-white transition-colors p-1 rounded active:scale-95"
            >
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
                <line x1="18" y1="6" x2="6" y2="18" />
                <line x1="6" y1="6" x2="18" y2="18" />
          ...
          <div className="bg-zinc-950 border border-white/10 w-full max-w-[420px] rounded-[32px] overflow-hidden shadow-2xl animate-in slide-in-from-bottom-8 duration-500" dir="rtl">
            <div className="p-6 pt-8">
              <div className="flex justify-between items-start mb-6">
                ...
                <button onClick={() => setShowInstallTutorial(false)} className="bg-white/5 hover:bg-white/10 text-white/40 hover:text-white transition-all p-2 rounded-full">
                  ...
                  {isIosPwa ? (
                    <>
                      <div className="flex gap-4 items-start">
                        ...
                        <div className="text-white/80 text-[15px] leading-snug pt-1">לחץ על כפתור ה-<span className="font-bold">שיתוף</span> בסרגל התחתון.</div>
                      </div>
                      <div className="flex gap-4 items-start">
                        ...
                        <div className="text-white/80 text-[15px] leading-snug pt-1">גלול למטה ובחר <span className="font-bold">&quot;הוסף למסך הבית&quot;</span>.</div>
                      </div>
                      <div className="flex gap-4 items-start">
                        ...
                        <div className="text-white/80 text-[15px] leading-snug pt-1">לחץ על <span className="font-bold">&quot;הוסף&quot;</span> בפינה העליונה.</div>
                      </div>
                    </>
                  ) : (
                    <>
                      <div className="flex gap-4 items-start">
                        <div className="flex-shrink-0 w-8 h-8 rounded-full bg-blue-500/10 border border-blue-500/20 flex items-center justify-center text-sm font-bold text-blue-400">1</div>
                        <div className="text-white/80 text-[15px] leading-snug pt-1">לחץ על הכפתור <span className="font-bold">&quot;התקן אפליקציה&quot;</span> למטה.</div>
                      </div>
                      <div className="flex gap-4 items-start">
                        <div className="flex-shrink-0 w-8 h-8 rounded-full bg-blue-500/10 border border-blue-500/20 flex items-center justify-center text-sm font-bold text-blue-400">2</div>
                        <div className="text-white/80 text-[15px] leading-snug pt-1">אשר את ההתקנה בחלון שיפתח.</div>
                      </div>
                    </>
                  )}
                </div>
                <div className="bg-amber-500/10 border border-amber-500/20 rounded-2xl p-4 flex gap-3">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" className="text-amber-400 mt-0.5 flex-shrink-0"><circle cx="12" cy="12" r="10" /><line x1="12" y1="8" x2="12" y2="12" /><line x1="12" y1="16" x2="12.01" y2="16" /></svg>
                  <p className="text-amber-200/80 text-xs leading-relaxed font-medium"><span className="font-bold">חשוב:</span> לאחר ההתקנה, פתח את האפליקציה מהאייקון החדש במסך הבית כדי להפעיל את ההתראות.</p>
                </div>
                <div className="pt-2 space-y-3 pb-2">
                  {!isIosPwa && (
                    <button onClick={handlePwaInstall} className="w-full bg-blue-500 hover:bg-blue-600 text-white font-bold py-4 rounded-2xl transition-all active:scale-[0.98] shadow-lg shadow-blue-500/25 flex items-center justify-center gap-2">
